...
class MapGenerator:
    ...
    def set_world_coarse(self, world_coarse_maps):
        self.world_coarse = world_coarse_maps
    ...
    def generate(
        ...
        **kwargs,
        ...
        channel_arrays = extract_channels(coarse_maps, **kwargs)
