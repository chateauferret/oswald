...
if __name__ == "__main__":
    dataset = CoarseDataset(
        h5_file=get_data_path('coarse.h5'),
        etopo_file=get_data_path('global/ETOPO_2022_v1_30s_N90W180_bed.tif'),
        mean_temp_file=get_data_path('global/wc2.1_30s_bio_1.tif'),
        std_temp_file=get_data_path('global/wc2.1_30s_bio_4.tif'),
        mean_precip_file=get_data_path('global/wc2.1_30s_bio_12.tif'),
        std_precip_file=get_data_path('global/wc2.1_30s_bio_15.tif'),
        crop_size=32,
    )
