...
if __name__ == "__main__":
    dataset = BiomeDataset(
        temp_file=get_data_path('global/wc2.1_30s_bio_1.tif'),
        temp_std_file=get_data_path('global/wc2.1_30s_bio_4.tif'),
        precip_file=get_data_path('global/wc2.1_30s_bio_12.tif'),
        precip_std_file=get_data_path('global/wc2.1_30s_bio_15.tif'),
        koppen_file=get_data_path('global/koppen_geiger_0p00833333.tif'),
        length=1_000_000,
        seed=0,
        input_dropout=0.2,
    )
