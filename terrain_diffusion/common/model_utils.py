import os
from terrain_diffusion.paths import get_checkpoint_path
from ema_pytorch import PostHocEMA
from safetensors.torch import load_model

# Local paths -> HuggingFace repo fallbacks
MODEL_PATHS = {
    "coarse": (get_checkpoint_path("models/diffusion_coarse"), "xandergos/TerrainDiffusion-Diffusion-Coarse-128A"),
    "base": (get_checkpoint_path("models/consistency_base-192x3"), "xandergos/TerrainDiffusion-Consistency-Base-192x3"),
    "decoder": (get_checkpoint_path("models/consistency_decoder-64x3"), "xandergos/TerrainDiffusion-Consistency-Decoder-64x3"),
    "diffusion_base": (get_checkpoint_path("models/diffusion_base-192x3"), "xandergos/TerrainDiffusion-Diffusion-Base-192x3"),
    "diffusion_base_guide": (get_checkpoint_path("models/diffusion_base-128x3"), "xandergos/TerrainDiffusion-Diffusion-Base-128x3"),
}
